...
EventQuantity.prototype = {
    ...
    new Ajax.Updater(update_element, "/ticket_booking/ajax_get_quantity_options_for_event", {
     	method: 'post',
...
function card_cvv(select_card, text_cvv) {
  ...
  function showAvailabilityTime(element, index) {
    ...
    $("time_"+id).show();
    element.options.selectedIndex = (index-1);
  }
